...
State 2 in `results/REPRODUCIBILITY.md`: the mechanism is pinned; the reported numbers come from a data-run over BigQuery downloads that live outside this repository, which is not committed, and are not asserted.
