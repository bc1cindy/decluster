...
The value dimension here is a threshold, not an optimisation: a coin either can or cannot carry the amount, and pruning on that is as cheap as the cut itself. Choosing which routes carry how much — the k-splittable formulation — is the hard problem and is not this one.
