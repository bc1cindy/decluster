...
> **Canonical status (2026-09-04).** The deterministic nominal-value provenance contract is now
> generated by `decluster.experiments.ancestry_contract` and registered in
> `catalog/runs/ancestry-contract-v1.json`. It covers the absorbing distribution, the exact
