...
def x_uih_fee_aware(tx):
    """Paper-faithful UIH1/UIH2 category, including explicit invalid/scope states."""
    from .baselines.unnecessary_input import analyze_transaction

    return analyze_transaction(tx).status.value
